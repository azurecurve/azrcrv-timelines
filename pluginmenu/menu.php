 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_t')){
	function azrcrv_create_plugin_menu_t(){
		azrcrv_create_plugin_menu_table_t();
		azrcrv_populate_plugin_menu_table_t();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_t')){
	function azrcrv_populate_plugin_menu_table_t(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_t')){
	function azrcrv_create_plugin_menu_table_t(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';

...
$tab_settings_label     = esc_html__( 'Settings', 'azrcrv-t' );
$tab_instructions_label = esc_html__( 'Instructions', 'azrcrv-t' );
...
<div class="azrcrv-donate">
	<?php esc_html_e( 'Support', 'azrcrv-t' ); ?>
	...
	<span>
		<?php esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'azrcrv-t' ); ?>
	</span>
</div>
